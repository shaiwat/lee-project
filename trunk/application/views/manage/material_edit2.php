<div id="tabs" >
	<ul>
		<li><a href="#tabs-1">แก้ไขครุภัณฑ์</a></li>
	</ul>
	<div id="tabs-1">
<?php echo validation_errors('<div class="error-message" style="width:437px;">', ' </div>'); ?>
<form id="myform" method="post" action="<?php echo site_url("manage/material_edit2/".$rows[0]['m_id']); ?>">
	...
	<div class="field">รหัสครุภัณฑ์<br>
         <input type="text"  name="mcode" value="<?php echo set_value('mcode',$rows[0]['mcode']); ?>"  class="textfield">
	</div>
