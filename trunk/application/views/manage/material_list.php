<div id="tabs" >
	<ul>
		<li><a href="#tabs-1">รายการวัสดุ</a></li>
...
<table cellspacing="0" cellpadding="0" border="1" width="100%" class="reference">
	<tbody>
		<tr>
			...
			<th align="left" style="width: 90px;">ชื่อวัสดุ</th>
...
<tr >
    ...
    <a href="<?php echo site_url("manage/material_edit/".$row['m_id']); ?>"><img src="images/document.png"></a></td>
    <td  class="<?php  echo $class; ?>" >
                        
    <a href="<?php echo site_url("manage/material_delete/".$row['m_id']); ?>"><img src="images/delete.png"></a></td>
</tr>
<?php  }?> 	
