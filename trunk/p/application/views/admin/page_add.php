...
?>
        ...
        <form class="form" method="post" action="<?php echo site_url("admin/page_add");  ?>">
         <?php echo  validation_errors('<div class="error"> <span class="strong"></span>', '</div>'); ?>
        <fieldset>
           <legend>เพิ่มหน้าเวบใหม่</legend>
        <div class="field">
		 ...
		 <input type="text" name="keyword" value="<?php echo set_value("keyword",""); ?>"><br>
		 </div>
		 <div class="field">
       ...
       <div class="cleaner"></div> 
        <div class="field">
		 ...
		 <input type="text" name="title_en" value="<?php echo set_value("title_en",""); ?>"><br>
		  ...
		  <div class="cleaner"></div> 
		  <div class="field">
          <label for="product_name_th">Thumbnail:</label><br>
