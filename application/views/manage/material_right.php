...
<a <?php if($f=="materials"){ echo 'class="active"'; } ?>  href="<?php echo site_url("manage/customers"); ?>" >รายการวัสดุ</a>
<a <?php if($f=="materials2"){ echo 'class="active"'; } ?>  href="<?php echo site_url("manage/customers"); ?>" >รายการครุภัณฑ์่</a>
