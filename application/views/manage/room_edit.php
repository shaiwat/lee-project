<div id="tabs" >
	<ul>
		<li><a href="#tabs-1">แก้ไขห้อง/สถานที</a></li>
	</ul>
	<div id="tabs-1">
<?php echo validation_errors('<div class="error-message" style="width:437px;">', ' </div>'); ?>
<form id="myform" method="post" action="<?php echo site_url("manage/room_edit/".$rows[0]['room_id']); ?>">
    <div class="field">ชื่อห้อง/สถานที่<br>
         <input type="text"  name="room_name" value="<?php echo set_value('room_name',$rows[0]['room_name']); ?>"  class="textfield">
	</div>
